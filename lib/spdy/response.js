...
exports.writeHead = function writeHead (statusCode, reason, obj) {
  ...
  // Repair using depreciate property. see: https://nodejs.org/api/deprecations.html#deprecations_dep0066_outgoingmessage_prototype_headers_outgoingmessage_prototype_headernames
  if (this.getHeaders()) {
